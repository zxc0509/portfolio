...
<c:if test="${list != null}">
	...
	<div class="container">
	  <form name="fr" method="post" action="${contextPath}/to/updateTourPro.do" enctype="multipart/form-data">
	    ...
	    <div class="row">
	      ...
	      <div class="col-80">
	        <input type="text" id="subject" name="title" value="${list['title']}">
	      </div>
	    </div>
	    <div class="row">
	      <div class="col-20">
	      ...
	      <div class="col-80">
	        <input type="text" id="tour_num" name="tour_num" value="${list['tour_num']}">
	      </div>
	    </div>
	    <div class="row">
	      <div class="col-20">
	    ...
	    <div class="row">
	      ...
	      <div class="col-80">
	       <img alt="" src="${contextPath}/tourImage/${num}/${list['img1']}" style="width: 360px;height:270pxs;">
	    ...
	    <div class="row">
	      ...
	      <div class="col-80">
	      <img alt="" src="${contextPath}/tourImage/${num}/${list['img2']}" style="width: 360px;height:270pxs;">
	    ...
	    <div class="row">
	      ...
	      <div class="col-80">
	      <img alt="" src="${contextPath}/tourImage/${num}/${list['img3']}" style="width: 360px;height:270pxs;">
	    ...
	    <div class="row">
	      ...
	      <div class="col-80">
	      <img alt="" src="${contextPath}/tourImage/${num}/${list['img4']}" style="width: 360px;height:270pxs;">
	    ...
	    <div class="row">
	      ...
	      <div class="col-80">
	      <img alt="" src="${contextPath}/tourImage/${num}/${list['img5']}" style="width: 360px;height:270pxs;">
