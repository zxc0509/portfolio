...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-sm-11">
			<form action="${contextPath}/mem/mypagePro.do" method="post" style="border:1px solid #ccc; text-align:center">
			<br>
			<h1>회원정보 수정</h1>
			<hr>
		    ...
		    <label for="psw-repeat"><b>Repeat Password</b></label>
   			 <input type="password" id="passwd-repeat" name="passwd-repeat" value="${vo.passwd}" onblur="checkPwd2()" required><br>
