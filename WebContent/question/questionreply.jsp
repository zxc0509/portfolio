...
<c:set var="id" value="${sessionScope.id }"/>
 	<div class="container" style="margin-top: 10px;">
		<div class="col-sm-12">						
			<form action="${contextPath }/que/replyWrite.do" method="post" >																							
					<input type="hidden" name="num" value="${num}">
					<input type="hidden" name="re_ref" value="${re_ref}">
					<input type="hidden" name="re_lev" value="${re_lev}">
					<input type="hidden" name="re_seq" value="${re_seq}">
					
					<h2 align="center">공지사항 게시판 답글 작성</h2>
					<br>
					<table class="table">
						<tr>
							...
							<td><input type="text" class="form-control" readonly="readonly" name="id" value="${sessionScope.id }">
							</td>
							</tr> 							
						<tr>
						<th  width="100px" style="padding: auto;"><h5>
